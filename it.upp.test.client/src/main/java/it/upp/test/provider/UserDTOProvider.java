...
public class UserDTOProvider implements MessageBodyWriter<UserDTO>, MessageBodyReader<UserDTO>{
	
	private static final Logger logger = LogManager.getLogger(UserDTOProvider.class);
